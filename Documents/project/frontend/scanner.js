...
const Scanner = (() => {
  ...
  //
  // Качеството е 0.92, не 0.82: молив върху тетрадъчен лист е тънък ръб с нисък
  // контраст, тоест точно това, което JPEG жертва първо. Мерено на истинска снимка
  // при 1568px — 121 KB при 0.82 срещу 187 KB при 0.92, при таван 1.4 MB за снимка
  ...
  function showStage(id) {
    ...
    // Живата рамка около страницата се върти на всеки кадър. Досега тя се спираше
    // само при гасене на камерата: докато човекът кадрира или избира филтър,
    // цикълът продължаваше да се буди шейсет пъти в секунда, за да установи, че
