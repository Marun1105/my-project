...
//
// ВНИМАНИЕ: картинките се четат ОТ КЕША преди мрежата (виж IMMUTABLE по-долу).
// Смени ли се съдържанието на картинка, без да ѝ се смени името, номерът тук
